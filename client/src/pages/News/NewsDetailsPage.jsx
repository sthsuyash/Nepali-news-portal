  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const relatedNewsData = await api.get(
          `/posts/recommended/${newsData.data.data?.id}`
        );
        // TODO: remove this
        console.log('Recommended news:', relatedNewsData.data.data);
            ...
            <div className='w-full xl:w-4/12'>
              <div className='w-full pl-0 xl:pl-4'>
                <div className='flex flex-col gap-y-8'>
                  <Search />
                  <RecentNews />
                  <div className='p-4 bg-whit rounded-mde'>
