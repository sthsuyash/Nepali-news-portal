...
const NewsDetailsMain = ({ news }) => {
  ...
  const { isTranslating, translatedSummary, handleTranslate } = useTranslation(
    news.summary
  );
    ...
    <div className='flex flex-col gap-y-5 bg-white rounded-t-md'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex gap-4'>
            <button
              ...
              {...(isBookmarked && { 'aria-pressed': 'true' })}
            >
              {loading ? (
      ...
      >
        <div className='px-6 py-4'>
          ...
          {translatedSummary && (
            <div className='mt-6 bg-gray-50 p-4 rounded-lg shadow-md text-justify'>
