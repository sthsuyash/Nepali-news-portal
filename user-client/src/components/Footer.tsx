      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-between space-x-8">
          ...
          <div className="w-full sm:w-1/3 lg:w-1/4">
            ...
            <br />
            <a href="/about-us" className="text-gray-800 hover:underline text-sm">पूरा पढ्नुहोस् »</a>
          </div>
        ...
        <div className="mt-10 flex space-x-6 justify-center">
          ...
          <Link href="https://itunes.apple.com/np/app/kantipur-daily/id1247241220?mt=8" target="_blank" rel="noopener noreferrer">
            <img
        ...
        <div className="mt-12 text-center text-sm text-gray-500">
          &copy; 2024 Nepali Publications Pvt. Ltd. All Rights Reserved.
          <br />
          Developed by <Link href="https://www.suyashshrestha.com.np" className="text-blue-500 hover:text-blue-700">Suyash Shrestha</Link> | <Link href="https://github.com/amishb7" className="text-blue-500 hover:text-blue-700">Amish Bajracharya</Link> | <Link href="https://github.com/prashannastha7" className="text-blue-500 hover:text-blue-700">Prashanna B. Shrestha</Link>
          <br />
          ...
          <br />
          <a href="/cookie-policy" className="text-blue-500 hover:text-blue-700">Cookie Policy</a> | <a href="/contact" className="text-blue-500 hover:text-blue-700">Contact
            Us</a>
          <br />
